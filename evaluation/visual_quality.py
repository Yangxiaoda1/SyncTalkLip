...
def main(args):
    ...
    for line in lines:
        ...
        for i in range(len_com):
            ...
            ssim.append(structural_similarity(gt_re, synt_re, multichannel=True, gaussian_weights=True, sigma=1.5, use_sample_covariance=False, data_range=255,channel_axis=-1))
